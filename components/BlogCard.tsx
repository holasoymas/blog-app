...
export default function BlogCard({ blog }: { blog: Blog }) {
  return (
    <div className="relative rounded-2xl p-4 bg-white dark:bg-gray-800 shadow-md hover:shadow-lg transition w-full max-w-xl mx-auto mb-6">
      {/* Top Right Buttons */}
      ...
      <div className=" bottom-3 right-3 flex gap-2 z-10">
